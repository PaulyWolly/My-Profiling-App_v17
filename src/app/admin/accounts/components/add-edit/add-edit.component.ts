...
export class AddEditComponent implements OnInit, OnDestroy {
            ...
            this.accountService.getById(this.id)
                ...
                .subscribe({
                    next: (account) => {
                        ...
                        // Check if current user can modify this account
                        if (account.role === Role.SuperAdmin && this.currentUserRole !== Role.SuperAdmin) {
                            this.error = 'Unauthorized: Only Super-Admin can modify Super-Admin accounts';
                            this.loading = false;
                            return;
                        }
    ...
    onSave(formData: any) {
        ...
        if (!this.isAddMode && this.account && this.account.role === Role.SuperAdmin && this.currentUserRole !== Role.SuperAdmin) {
            this.alertService.error('Unauthorized: Only Super-Admin can modify Super-Admin accounts');
